...
void showDetectedObjects(const cv::Mat& img, const std::vector<BoundingBox>& bBoxes, std::string classesFile,
                         const cv::Scalar& bboxFrameColor = {0, 255, 0},
                         std::string windowName = "Detected objects of current frame");
